...
<%  
    // Obtener datos del post a modificar del servlet
...
<div class="container mt-4">
    ...
    <form action="ModifyPostServlet" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description" name="description" placeholder="Ingrese la descripción" required><%= description %></textarea>
        </div>
        <div class="mb-3">
            <label for="price" class="form-label">Precio:</label>
            <input type="text" class="form-control" id="price" name="price" placeholder="Ingrese el precio" value="<%= price %>" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="duration" name="duration" placeholder="Ingrese la duración del alquiler" value="<%= duration %>" required>
